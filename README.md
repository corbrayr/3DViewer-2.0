...
In this project in C++ programming language in the paradigm of object-oriented programming an application for viewing 3D models in wireframe view is implemented.  
The models themselves should be loaded from .obj files. The project implements the ability to view models on the screen by rotating, scaling and moving objects.  

### Demonstration of the program interface
> Loaded model cat.obj
![Demonstration of the program interface. Loaded model cat.obj](src/docs/meta/cat.png)
  
### Demonstration of the display window
> Loaded model cube.obj
![Demonstration of the display window. Loaded model cube.obj](src/docs/meta/cube.gif)
